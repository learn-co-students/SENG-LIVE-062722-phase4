...
Ticket.create(user:u1, production: Production.find(2), price:65.00)
Ticket.create(user:u2, production: Production.find(2), price:65.00)
Ticket.create(user:u2, production: Production.first, price:65.00)
